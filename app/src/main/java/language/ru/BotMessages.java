...
public class BotMessages {
    ...
    public static final String CONFIRM_INGREDIENTS_UPDATE = "Хочешь обновить ингредиенты блюда? (Да/Нет)";
    ...
    public static final String CONFIRM_RECIPE_UPDATE = "Хочешь обновить рецепт блюда? (Да/Нет)";
